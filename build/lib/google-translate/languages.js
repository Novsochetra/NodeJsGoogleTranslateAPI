...
exports.isSupported = exports.getCode = exports.languages = void 0;
exports.languages = {
    auto: "Automatic",
    af: "Afrikaans",
    sq: "Albanian",
...
function getCode(desiredLang) {
    ...
    if (exports.languages[desiredLang]) {
        return desiredLang;
    }
    var keys = Object.keys(exports.languages).filter(function (key) {
        if (typeof exports.languages[key] !== "string") {
            return false;
        }
        return exports.languages[key].toLowerCase() === desiredLang;
    });
    return keys[0] || false;
}
